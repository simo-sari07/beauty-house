<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <x-input-label for="address" :value="__('Detailed Address')" />
                <x-textarea-input id="address" name="address" class="mt-1 block w-full" :value="old('address', $user->address)" autocomplete="street-address" rows="3" />
